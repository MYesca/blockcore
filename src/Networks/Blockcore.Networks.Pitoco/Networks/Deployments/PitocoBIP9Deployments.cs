...
namespace Blockcore.Networks.Pitoco.Networks.Deployments
{
   /// <summary>
   /// BIP9 deployments for the Blockcore sample coin network.
   /// </summary>
   public class PitocoBIP9Deployments : BIP9DeploymentsArray
   {
      ...
      /// </summary>
      public PitocoBIP9Deployments() : base(NumberOfDeployments)
      {
      }
