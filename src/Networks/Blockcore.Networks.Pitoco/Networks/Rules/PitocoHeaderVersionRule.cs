...
namespace Blockcore.Networks.Pitoco.Networks.Rules
{
   /// <summary>
   /// Checks if <see cref="PitocoMain"/> network block's header has a valid block version.
   /// </summary>
   public class PitocoHeaderVersionRule : HeaderVersionRule
   {
      /// <inheritdoc />
      ...
      public override void Run(RuleContext context)
      {
         ...
         // block versions above 7 and below 0x25001000.
