...
using Blockcore.Networks.Pitoco.Networks.Deployments;
using Blockcore.Networks.Pitoco.Networks.Policies;
using Blockcore.Networks.Pitoco.Networks.Rules;
...
{
    public class PitocoMain : Network
    {
        public PitocoMain()
        {
            CoinSetup setup = PitocoSetup.Instance.Setup;
            NetworkSetup network = PitocoSetup.Instance.Main;

            NetworkType = NetworkType.Mainnet;
            DefaultConfigFilename = setup.ConfigFileName; // The default name used for the Pitoco configuration file.
            ...
            var bip9Deployments = new PitocoBIP9Deployments()
            {
                [PitocoBIP9Deployments.CSV] = new BIP9DeploymentsParameters("CSV", 0, BIP9DeploymentsParameters.AlwaysActive, 999999999, BIP9DeploymentsParameters.AlwaysActive),
                [PitocoBIP9Deployments.Segwit] = new BIP9DeploymentsParameters("Segwit", 1, BIP9DeploymentsParameters.AlwaysActive, 999999999, BIP9DeploymentsParameters.AlwaysActive),
                [PitocoBIP9Deployments.ColdStaking] = new BIP9DeploymentsParameters("ColdStaking", 2, BIP9DeploymentsParameters.AlwaysActive, 999999999, BIP9DeploymentsParameters.AlwaysActive),

                //[PitocoBIP9Deployments.ColdStaking] = new BIP9DeploymentsParameters("ColdStaking", 2,
            ...
            Consensus.PosEmptyCoinbase = PitocoSetup.Instance.IsPoSv3();
            Consensus.PosUseTimeFieldInKernalHash = PitocoSetup.Instance.IsPoSv3();
            ...
            StandardScriptsRegistry = new PitocoStandardScriptsRegistry();
        ...
        protected void RegisterRules(IConsensus consensus)
        {
            consensus.ConsensusRules
                ...
                .Register<PitocoHeaderVersionRule>()
